...
const SETTINGS: AppSettings = {
  ...
  URL_REPLACE_TO: "https://x.com/", // E.g., "" | `https://twitter.com/` | `https://x.com/`. Target URL pattern for replacement.
  URL_NO_TRIM_DOMAINS: [
...
/** Character map: HTML entities â†’ Unicode */
const CHAR_MAP: { [key: string]: string } = {
   ...
   "&hellip;": "â€¦",         // Ellipsis - common in articles
   "&mdash;": "â€”",          // Em dash - common in articles
   "&ndash;": "â€“",          // En dash
   ...
   "&euro;": "â‚¬",           // Euro sign - very common
   "&pound;": "Â£",          // British pound
   "&yen;": "Â¥",            // Japanese yen
   "&cent;": "Â¢",           // Cent
   "&copy;": "Â©",           // Copyright - common
   "&reg;": "Â®",            // Registered trademark - common
   "&trade;": "â„¢",          // Trademark
   "&deg;": "Â°",            // Degree symbol (temperatures!)
   "&plusmn;": "Â±",         // Plus-minus
   "&times;": "Ã—",          // Multiplication
   "&divide;": "Ã·",         // Division
   "&frac14;": "Â¼",         // 1/4 fraction
   "&frac12;": "Â½",         // 1/2 fraction
   "&half;": "Â½",           // 1/2 fraction (alternative)
   "&frac34;": "Â¾",         // 3/4 fraction
   ...
   "&prime;": "â€²",          // Prime
   "&Prime;": "â€³",          // Double prime
   "&permil;": "â€°",         // Per mille
   "&thickapprox;": "â‰ˆ",    // Approximately equal
   "&ne;": "â‰ ",             // Not equal
   "&minus;": "âˆ’",          // Minus sign
   "&bull;": "â€¢",           // Bullet
   "&middot;": "Â·",         // Middle dot
   "&centerdot;": "Â·",      // Center dot (alternative)
   "&sect;": "Â§",           // Section sign
   ...
   "[&hellip;]": "â€¦", "[&amp;hellip;]": "â€¦", "&amp;hellip;": "â€¦",
   "[&mldr;]": "â€¦", "[&amp;mldr;]": "â€¦", "&mldr;": "â€¦", "&amp;mldr;": "â€¦",
