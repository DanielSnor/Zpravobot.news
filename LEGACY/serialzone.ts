...
///////////////////////////////////////////////////////////////////////////////
const entryContent = String(Feed.newFeedItem.EntryTitle);
...
///////////////////////////////////////////////////////////////////////////////
// IFTTT 🦋🐦‍⬛📙📘🐦📺 webhook filter v0.9.5 - 16.10.2024
///////////////////////////////////////////////////////////////////////////////
...
function composeResultStatus(
  ...
  resultImageUrl = trimUrl(resultImageUrl)
