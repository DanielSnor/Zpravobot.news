///////////////////////////////////////////////////////////////////////////////
// IFTTT 🦋📙📘𝕏📺 webhook filter v1.0 RC1 - 15.2.2025
///////////////////////////////////////////////////////////////////////////////
...
function composeResultStatus(
  ...
  if (isImageInPost(entryImageUrl) && SETTINGS.SHOW_IMAGEURL) {
    resultStatus = `${resultStatus}${SETTINGS.STATUS_IMAGEURL_SENTENCE}${resultImageUrl}`;
  }
  ...
  if (repostUrl) {
    ...
    resultStatus = `${resultStatus}${SETTINGS.STATUS_URL_SENTENCE}${resultUrl}`;
  }
