...
const SETTINGS: AppSettings = {
  ...
  EXCLUDED_URLS: ["facebook.com", "www.facebook.com", "youtu.be", "youtube.com"], // E.g., ["youtu.be", "youtube.com", "example.com"]. URLs in this list are excluded from trimming but still encoded.
  MANDATORY_KEYWORDS: [], // E.g., ["news", "updates", "important"]. Leave empty to disable mandatory keyword filtering.
  MENTION_FORMATTING: { "RSS": { type: "prefix", value: "https://www.instagram.com/" }, }, // Default behavior if platform-specific rule is missing.
